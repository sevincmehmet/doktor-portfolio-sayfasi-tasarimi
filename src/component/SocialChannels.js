    ...
    return (
        <>
            <div id="home-bottom" className="container">
                <h2 data-wow-delay="0.1s" className="wow fadeInLeft home-title text-center" style={{ fontSize: "31.5px" }}>
                    ...
                    <div className="offset-xxl-1 col-xxl-10 offset-xxl-1 ">
                        <div className="row" style={{ padding: "27px 0" }}>
                            <div data-wow-delay="0.1s"
                                className="wow fadeInLeft col-sm-6 col-md-4 mb-4">
                            ...
                            <div data-wow-delay="0.3s"
                                className="wow fadeInLeft col-sm-6 col-md-4">
